...
public class BasicAuthenticationTest {
    ...
    void test_3(){
        ...
        // TestRestTemplate이 기본적으로 Basic 인증 토큰을 넣어서 날려줌
    ...
    void test_4(){
        TestRestTemplate testClient = new TestRestTemplate("user1", "1111");
        ResponseEntity<String> resp = testClient.postForEntity(greetingUrl(), "jy", String.class);
        assertEquals("hello jy", resp.getBody());
    }
}
